...
@Autonomous
public class Auto_Middle_Right extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d StartPose = new Pose2d(-64, -33);
        ...
        Trajectory myTrajectorySpline7 = drive.trajectoryBuilder(myTrajectorySpline6.end())
                ...
                .build(); // отъезд назад
        Trajectory myTrajectorySpline8 = drive.trajectoryBuilder(new Pose2d(-44, -30/*-17, 29*/, Math.toRadians(-90)))
                .lineTo(new Vector2d(-44/*-20*/, y))
                .build(); //парковка
        waitForStart();
