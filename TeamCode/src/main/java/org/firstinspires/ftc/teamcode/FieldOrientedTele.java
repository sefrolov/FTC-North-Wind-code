...
public class FieldOrientedTele extends LinearOpMode {
    RobotNW Robot = new RobotNW();
    double[] basePos = {0, 0, 0, 0};
    vec2 JoysticDir, Speed;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            double koef = 1.;
            JoysticDir.set(gamepad1.left_stick_x, -gamepad1.left_stick_y);
            Speed.set(JoysticDir.turn(-Robot.IMU.getPositiveAngle() + 2 * PI));
            ...
            Robot.WB.applySpeed(Speed.X, Speed.Y, rotate, koef);
