...
public class AutoRedRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        Robot.WB.applyBreak();
        Robot.WB.applySpeed(0.3, -0.06, 0, 1);
        timer.reset();
        while(timer.milliseconds() < 1200 && !isStopRequested());
        Robot.WB.applyBreak();

        if(Robot.IMU.getAngle() > 0){
