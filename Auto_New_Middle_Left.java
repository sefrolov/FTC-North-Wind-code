...
@Autonomous
public class Auto_New_Middle_Left extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory myTrajectorySpline4 = drive.trajectoryBuilder(myTrajectorySpline3.end())
                ...
                .splineToSplineHeading(new Pose2d(-24, 51, Math.toRadians(-90)), Math.toRadians(-90))
                .build(); //2 дж
        ...
        Trajectory myTrajectorySpline6 = drive.trajectoryBuilder(myTrajectorySpline5.end())
                ...
                .splineToSplineHeading(new Pose2d(-22.5, 52, Math.toRadians(-90)), Math.toRadians(-90))
                .build(); //2 дж*/
