...
@Autonomous
public class Auto_3_Middle_Right extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory myTrajectorySpline = drive.trajectoryBuilder(StartPose)
                .lineToSplineHeading(new Pose2d(-15.5, -46, Math.toRadians(0)))
                .splineToSplineHeading(new Pose2d(-23, -30, Math.toRadians(-47)), Math.toRadians(133))
                .build();
        Trajectory myTrajectorySpline2 = drive.trajectoryBuilder(myTrajectorySpline.end())
                ...
                .lineToSplineHeading(new Pose2d(-19.5, -72, Math.toRadians(-90)))
                .build(); //стопка
        Trajectory myTrajectorySpline3 = drive.trajectoryBuilder(myTrajectorySpline2.end())
                ...
                .splineToSplineHeading(new Pose2d(-30, -36, Math.toRadians(-30)), Math.toRadians(125))
                .build(); //2 дж
        ...
        /*Trajectory myTrajectorySpline21 = drive.trajectoryBuilder(myTrajectorySpline3.end())
                .splineToSplineHeading(new Pose2d(-35, 55, Math.toRadians(90)), Math.toRadians(90))
                .lineToSplineHeading(new Pose2d(-35, 70, Math.toRadians(90)))
                .build(); //стопка
        Trajectory myTrajectorySpline31 = drive.trajectoryBuilder(myTrajectorySpline21.end())
                .lineToSplineHeading(new Pose2d(-19.75, 60, Math.toRadians(90)))
                .splineToSplineHeading(new Pose2d(-30, 32.5, Math.toRadians(45)), Math.toRadians(-135))
                .build(); //2 дж*/
        ...
        Trajectory myTrajectorySpline61 = drive.trajectoryBuilder(myTrajectorySpline6.end())
                .lineToSplineHeading(new Pose2d(-18, y, Math.toRadians(90)))
                .build();
        ...
        new_thread.EL.changeover.setPosition(0.25);
